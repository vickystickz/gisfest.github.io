      ...
      <div className="hero" id="top">
        <div className="hero-content">
          ...
          {/* <div className="hero-info flexbox">
           ...
           <a className="pro-button" href="https://www.youtube.com/watch?v=t6v_xyLRHq8&list=PLLlls9tZON6fwsAiQC_upJk9NDItORaOa" rel="noreferrer" target='_blank'>
              <BsFillCollectionPlayFill className="pro-Icon" />
              <span className="pro-text">Proceedings</span>
            </a>
